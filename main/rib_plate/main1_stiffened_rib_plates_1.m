...
S_plt_matrix2=-E*(-h/2)/(1-v^2)*((2/)^2*eval(subs(diff(tp1,x,2),x,x_loc)*subs(diff(py1,y,0),y,y_loc))-...
    v*(2/b)^2*eval(subs(diff(tp1,x,0),x,x_loc)*subs(diff(py1,y,2),y,y_loc)));

-E*-(h/2)/(1-v^2)*((2/a)^2*eval(subs(diff(tp1,x,0),x,x_loc)*subs(diff(py1,y,2),y,y_loc)));
